...
Misalkan kita mau nambah 5 jika elemen > 50, atau mengembalikan angka aslinya jika tidak.
...
- **for (i in 1:length(buah_buahan))**: Loop berjalan sebanyak panjang vektor, yang dihitung dengan fungsi length(). - **toupper(buah_buahan[i])**: Setiap elemen string diubah menjadi huruf kapital menggunakan fungsi toupper().
- **buah_buahan_kapital[i]** = ...: Hasil dari fungsi toupper() disimpan kembali dalam vektor buah_buahan_kapital.
