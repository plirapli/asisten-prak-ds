...
loan_data$Gender = as_factor(loan_data$Gender)
loan_data$Married = as_factor(loan_data$Married)
loan_data$Dependents = as_factor(loan_data$Dependents)
loan_data$Education = as_factor(loan_data$Education)
loan_data$Self_Employed = as_factor(loan_data$Self_Employed)
loan_data$Property_Area = as_factor(loan_data$Property_Area)
